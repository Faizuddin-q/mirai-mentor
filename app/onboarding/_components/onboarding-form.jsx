...
const OnboardingForm = ({ industries }) => {
  ...
  useEffect(() => {
    if (updateResult?.success && !updateLoading) {
      ...
      updateUserData();
      toast.success(
        "Profile completed successfully! Redirecting to applications tracker...",
      );
      router.refresh();
    }
  ...
  return (
    <div className="animate-fade-in-up">
      <div className="glass-card w-full max-w-lg mx-auto p-6 md:p-8 rounded-xl group relative overflow-hidden">
