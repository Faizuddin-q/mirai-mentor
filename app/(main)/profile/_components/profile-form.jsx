...
const ProfileForm = ({ industries, initialData }) => {
    ...
    if (initialData) {
      ...
      if (initialData.industry) {
        const industryData = industries.find(
          (ind) => ind.id === initialData.industry,
        );
  ...
  useEffect(() => {
    ...
    if (
      updateLoading ||
      (lastResultRef.current !== updateResult && !updateResult?.success)
    ) {
  ...
  return (
    <div className="animate-fade-in-up">
      <div className="glass-card w-full p-6 md:p-8 rounded-xl group relative overflow-hidden">
        ...
        <div className="relative z-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {watchIndustry && (
                <div className="space-y-2">
                  <Label htmlFor="subIndustry" className="font-semibold">
                    Specialization
                  </Label>
                  <Select
            ...
            <div className="flex gap-3 pt-4">
              <Button
                type="button"
                variant="outline"
                className="flex-1 border-primary/20 text-primary hover:bg-primary/10 transition-all rounded"
                onClick={() => router.back()}
              >
                Cancel
              </Button>
